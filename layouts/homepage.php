<div class="wrapper">
  <div class="maincontent">
    ...
    <section class="section hero">
      <div class="container">
        <header class="header">
          ...
          <div class="header__links"><a class="order-link btn" href="#sectionOrder">Заказать</a><a class="hamburger-menu-link" href="">
            ...
            <li class="burgers-slider__item">
              ...
              <div class="burgers-slider__right">
                ...
                <div class="burgers-slider__options">
                  ...
                  </div><a class="burgers-slider__buy btn" href="#sectionOrder">Заказать</a>
                </div>
              </div>
            </li>
            <li class="burgers-slider__item">
    ...
    <section class="section order">
      <div class="container">
        <a name="sectionOrder"></a>
        <div class="section__title">Закажите доставку</div>

        <?php // order form ?>
        <div class="order__form">
          <form class="order__form-tag" id="order-form" action="<?php echo BASE_URL ?>" method="POST">   
            ...
            <input type="hidden" name="engine" value="ajax">
            <input type="hidden" name="action" value="submitOrder">
            
          </form>


          <div class="status-popup popup orderAJAXResponce" id="orderAJAXResponce">
